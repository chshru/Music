...
public class PlayPauseButton extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mBgColor = ta.getColor(R.styleable.PlayPauseButton_bg_color, Color.WHITE);
        mBtnColor = ta.getColor(R.styleable.PlayPauseButton_btn_color, Color.BLACK);
        mGapWidth = ta.getFloat(R.styleable.PlayPauseButton_gap_width, 0);
        mBorderWidth = ta.getFloat(R.styleable.PlayPauseButton_border_width, 20);
        mDirection = ta.getInt(R.styleable.PlayPauseButton_anim_direction, Direction.POSITIVE.value);
        mPadding = ta.getFloat(R.styleable.PlayPauseButton_space_padding, 0);
        mAnimDuration = ta.getInt(R.styleable.PlayPauseButton_anim_duration, 200);
        ta.recycle();
